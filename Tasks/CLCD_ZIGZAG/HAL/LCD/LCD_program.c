...
{
	// LCD pins
	MCAL_DIO_voidSetPinMode(RS, Output); //Command pin - 1
	MCAL_DIO_voidSetPinMode(E  , Output); //Command pin - 2
	MCAL_DIO_voidSetPinMode(DB7, Output);//Data pin - 1
	MCAL_DIO_voidSetPinMode(DB6, Output);//Data pin - 2
	MCAL_DIO_voidSetPinMode(DB5, Output);//Data pin - 3
	MCAL_DIO_voidSetPinMode(DB4, Output);//Data pin - 4
	delay_ms(31);
